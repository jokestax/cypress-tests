        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    error_1 = _a.sent();
                    if (error_1.response) {
                        console.log("Status code is ".concat(error_1.response.status, ". Retrying in ").concat(interval / 1000, " seconds..."));
                    }
                    else {
                        console.log("Error: ".concat(error_1.message, ". Retrying in ").concat(interval / 1000, " seconds..."));
                    }
                    return [3 /*break*/, 3];
